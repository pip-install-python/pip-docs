...
from dash_leaflet import AntPath, TileLayer, MapContainer, Marker, Popup, Tooltip, Map
...
component=dmc.Grid([
        ...
        ], zoom=13, center=[51.51, -0.09], style={'height': '50vh', 'width': '100%'}
), span=12
        ),
        dmc.GridCol(children=[
            ...
            dmc.Stack([
                dmc.Group([
                    dmc.Stack([html.Label('Base Color'),
                        dmc.ColorPicker(id='color-picker', value='#0000FF', w='100%'),]),
                    dmc.Stack([html.Label('Pulse Color'),
                        dmc.ColorPicker(id='pulse-color-picker', value='#FFFFFF', w='100%')]),
                    dmc.Stack([
                    ...
                    dmc.Stack([
                        dmc.Switch(id='pause-switch', label='Pause Animation'),
                        dmc.Switch(id='reverse-switch', label='Reverse Animation'),
                    ]),
                ], grow=True, justify='center', gap='md'),
            ]),
        ], span=12),
    ], style={'padding': '20px'})
